$(function(){
    ...
    prezidenti.forEach(function(obj,idx){
        ...
        //kviz.append('<div class="col-sm-4"><figure><img src="img/'+obj.photo+'" alt="'+obj.name+'"><figcaption>'+obj.name+'</figcaption></figure></div>')
        kviz.append('<div class="col-sm-4"><figure id="'+idx+'"><img src="img/prezident0.jpg" alt="Prezident"><figcaption>'+obj.name+'</figcaption></figure></div>')
    });
    var photo = $('#kviz img');
